...
#                         tp([(0.5, 1), (0.5, 0)]))
    ...
    def testRotate(self):
        print "**************"
        print "rotate", sf.math2d_rotate((1, 0), 0)
    ...
    def testAngleToQuadrant(self):
        self.assertEqual(sf.math2d_angle_to_quadrant(0.0001), 0)
        self.assertEqual(sf.math2d_angle_to_quadrant(math.pi/4), 0)
        self.assertEqual(sf.math2d_angle_to_quadrant(-math.pi/4), 3)
        self.assertEqual(sf.math2d_angle_to_quadrant(math.pi/2 + 0.001), 1)
        self.assertEqual(sf.math2d_angle_to_quadrant(math.pi/2 - 0.001), 0)

        self.assertEqual(sf.math2d_angle_to_quadrant(3 * math.pi/2), 3)
        self.assertEqual(sf.math2d_angle_to_quadrant(3 * math.pi/2 + 0.001), 3)
        self.assertEqual(sf.math2d_angle_to_quadrant(3 * math.pi/2 - 0.001), 2)
        self.assertEqual(sf.math2d_angle_to_quadrant(2 * math.pi), 0)
