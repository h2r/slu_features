...
class TestCase(unittest.TestCase):
    ...
    def testPolygonInsideAnother(self):
        figure = Prism.from_points_xy(array([[  7.69945323,   7.69945323,  10.97806236,  11.42204982,
                                 8.47089291],
                              [ 54.13234479,  54.13234479,  55.86027265,  54.38893454,
                                52.75711988]]),
                       0.85000741680000036, 1.8500074168000005)
        landmark = Prism.from_points_xy(array([[  8.20976285,   7.35040178,  12.13996339,  12.99932446],
    ...
    def testNotOverlapping(self):
        fend = Prism.from_points_xy(array([[ 11.38086607,  11.11520079,  10.6916185 ,  10.95728378],
                          [ 50.18213065,  50.60571294,  50.34004767,  49.91646537]]), 0.0, 2.0)
        lend = Prism.from_points_xy(array([[  8.81022941,   8.31022943,   9.34945991,   9.8494599 ],
    ...
    def testSameFigureAndLandmark(self):
        ...
        f_prism = Prism.from_points_xy(array([[ 21.72099827,  21.22099828,  22.26022877,  22.76022875],
                              [ 40.789814  ,  41.65583942,  42.25583939,  41.38981397]]),
                       3.3273999996559184e-06, 0.70338871259999969)
        l_prism = Prism.from_points_xy(array([[ 21.72099827,  21.22099828,  22.26022877,  22.76022875],
                               [ 40.789814  ,  41.65583942,  42.25583939,  41.38981397]]),
                        3.3273999996559184e-06, 0.70338871259999969)
    ...
    def testSupports(self):
        f_prism = Prism.from_points_xy(array([[ 12.19116674,  11.65687213,  10.8115738 ,  11.34586841],
                               [ 49.87727769,  50.72257602,  50.18828141,  49.34298308]]), 0.0, 2.0)
        l_prism = Prism.from_points_xy(array([[ 10.61577541,  10.11577543,  11.15500591,  11.6550059 ],
    ...
    def testSupports1(self):
        f_prism =  Prism.from_points_xy(array([[ 16.26972295,  17.58320551,  16.85879986,  15.5453173 ],
                                [ 47.84974226,  48.57414791,  49.88763048,  49.16322482]]), 0.0, 2.0)
        l_prism =  Prism.from_points_xy(array([[ 17.28494274,  16.78494273,  17.82417321,  18.32417321],
    ...
    def testSupports2(self):
        f_prism =  Prism.from_points_xy(array([[ 12.40321594,  11.89190306,  10.48174026,  10.99305313],
                                [ 50.60192082,  52.01208363,  51.50077075,  50.09060794]]), 0.0, 2.0)
        l_prism =  Prism.from_points_xy(array([[ 10.77335704,  10.26535702,  11.3045877 ,  11.81258772],
